...
import F21ASE_Stage1.FlightList;

import static org.junit.Assert.*;

public class TestMyFlightList {
	...
	@Before
	public void setup() {
		flight1 = new Flight("London", "York", "UK Airway", "UK001", 100, 100, 100);
		flight2 = new Flight("Boston", "London", "US Airway", "US001", 50, 50, 50);
