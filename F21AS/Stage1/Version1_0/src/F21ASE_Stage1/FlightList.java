...
public class FlightList {
    ...
    private void readFile(String filename) {
        try {
            ...
            //read the first line of the input file to get the accommodation type
//            String cabin_type = scanner.nextLine();
    ...
    private void processLine(String line) {
        ...
        try {
            ...
            if (flightCodeValidation(flightCode)) {
                ...
                Flight f = new Flight(departure, destination, carrier, flightCode, maxNbrPassengers, maxBaggageWeight, maxBaggageVolume);
                this.addFlight(f);
            }
        }
     ...
     *
     * Correct flight code should start with 2 capital letters following by 2-4 numbers
     *
     * @param flightCode
     * @return boolean
     */
